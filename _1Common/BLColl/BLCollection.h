...
#define BLC_FULLACCESS  BLC_MODIFED | BLC_INSERT | BLC_MOVE
...
/*
				ItemType* pItemType = static_cast<ItemType*>(ppValue[1]->GetContext());
				pItemType->SetName(ppValue[0]->GetString());
				CCollection::Add(pItemType);
*/
