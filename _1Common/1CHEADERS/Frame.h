...
//SECControlBar(134h/B8h)<-CControlBar(7Ch/3Ch)<-CWnd(40h/20h)<-CCmdTarget(20h/1Ch)<-CObject(4h/4h)
...
//<-SECCustomToolBar(1A8h/74h)<-SECControlBar(134h/B8h)<-CControlBar(7Ch/3Ch)<-CWnd(40h/20h)<-CCmdTarget(20h/1Ch)<-CObject(4h/4h)
...
//<-CToolBar7(1A8h/0h)<-SECCustomToolBar(1A8h/74h)<-SECControlBar(134h/B8h)<-CControlBar(7Ch/3Ch)<-CWnd(40h/20h)<-CCmdTarget(20h/1Ch)<-CObject(4h/4h)
...
//<-CContainer(8Ch/38h)<-CDocument(54h/34h)<-CCmdTarget(20h/1Ch)<-CObject(4h/4h)
...
protected:
	 CContainer(void);	//6
public:
	COleStorage* m_pStorage;                                       // 54h
	CArray<CContainerPage*, CContainerPage*> m_ContainerPageArray; // 58h
	CMap<DWORD,DWORD,DWORD,DWORD> m_mapUnk;                        // 6Ch
	DWORD m_data1;                                                 // 88h
                                                                   // 8Ch
...
public:
	CPropPageData()
	{
		m_data0 = 0;
		//m_guid = 0;
		//m_PROPPAGEINFO = ppd2.m_PROPPAGEINFO;
		m_data1 = 0;
	};
	void operator=(CPropPageData const & ppd2)
	{
		m_data0 = ppd2.m_data0;
		m_guid = ppd2.m_guid;
		m_PROPPAGEINFO = ppd2.m_PROPPAGEINFO;
		m_data1 = ppd2.m_data1;
		m_str = ppd2.m_str;
	};
...
public:
	...
	DWORD m_CurrentPageIndex;   // A4h +  4h
...
//size of CComboBox is 40h
class IMPORT_1C CSearchBox : public CComboBox
{
public:
	DWORD m_data0;  // 40h
	DWORD m_data1;  // 44h
	DWORD m_data2;  // 48h
	DWORD m_data3;  // 4Ch (<- constructor argument)
	DWORD m_data4;  // 50h
	DWORD m_data5;  // 54h
...
//<-SECMDIFrameWnd(F8h/34h)<-CMDIFrameWnd(C4h/4h)<-CFrameWnd(C0h/80h)<-CWnd(40h/20h)<-CCmdTarget(20h/1Ch)<-CObject(4h/4h)
class IMPORT_1C SECMDIFrameWnd:public CMDIFrameWnd //CObject
{
public:
	DWORD m_data1;             // C4h
	DWORD m_data2;             // C8h
	DWORD m_ClientAreaWidth;   // CCh
	DWORD m_ClientAreaHeight;  // D0h
	char** m_pch;              // D4h
	DWORD m_data3;             // D8h
	DWORD m_data4;             // DCh
	DWORD m_data5;             // E0h
	SECToolBarManager* m_pToolBarManager; // E4h
	DWORD m_data6;             // E8h
	DWORD m_data7;             // ECh
	DWORD m_data8;             // F0h
	DWORD m_data9;             // F4h
...
//<-SECStatusBar(138h/4h)<-SECControlBar(134h/B8h)<-CControlBar(7Ch/3Ch)<-CWnd(40h/20h)<-CCmdTarget(20h/1Ch)<-CObject(4h/4h)
...
class IMPORT_1C CTBSearchBox : public CSearchBox, SECWndBtn
{
public:
