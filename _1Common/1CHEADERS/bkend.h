...
public:
	...
	CMetaDataObjArray m_ReportDefs;       //отчеты
	CMetaDataObjArray m_CalendarTypeDefs; //календари
	...
	CMetaDataObjArray m_DocSelRefDefs;    //графы отбора
	CMetaDataObjArray m_DocNumDefs;       //нумераторы
	CMetaDataObjArray m_DocStreamDefs;    //последовательности
...
public:
	...
	WORD type;       //08h
	BYTE m_prec;     //0Ah
	BYTE m_flags;	 //0Bh // Для чисел 1-разделять триады, 2 - неотрицательный
                     //size 0Ch
...
public:
	...
	class CNumeric m_Number;  //10h         // числовое значение // align 8
	class CString m_String;   //3Ch         // строковое значение
	class CDate m_Date;       //40h         // значение даты
	long ValTypeID;           //44h         //int Flag6;
	CBLContext* m_Context;    //48h         // значение контекста
	class CObjID m_ObjID;     //4Ch         // значение в базе
	                          //size 54h
