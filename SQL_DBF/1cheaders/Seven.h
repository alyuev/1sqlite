...
class IMPORT_1C CLogSkipper : public CSkipper
{
public:
	 CLogSkipper(void);	//55
...
class IMPORT_1C CUserSkipper : public CSkipper
{
public:
	DWORD m_data;               // 14h
	DWORD m_US_MaxIndex;        // 18h
	CMonitorDoc* m_pMonitorDoc; // 1Ch
...
//<-CMonitorDoc(F4h/54h)<-CGetDoc(A0h/4Ch)<-CDocument(54h/34h)<-CCmdTarget(20h/1Ch)<-CObject(4h/4h))
...
public:
	...
	CFile m_pFile;
	CArray<CMonitorRec, CMonitorRec&> m_ActiveUsers;
	DWORD m_data3;
	DWORD m_data4;
	CUserSkipper m_Skipper;
	CStringArray* m_pUserNameArray;
...
//<-CMonitorFrame(300h/80h)<-CChildFrame7(280h/1B8h)<-SECMDIChildWnd(C8h/0h)<-CMDIChildWnd(C8h/8h)<-CFrameWnd(C0h/80h)<-CWnd(40h/20h)<-CCmdTarget(20h/1Ch)<-CObject(4h/4h)
...
//<-CMonitorView(100h/68h)<-CBrowseView(98h/18h)<-CFormView(80h/10h)<-CScrollView(70h/2Ch)<-CView(44h/4h)<-CWnd(40h/20h)<-CCmdTarget(20h/1Ch)<-CObject(4h/4h)
