...
struct bindTextParam {
    ...
    void bindBlob(const CValue* pValue) {
        ...
        DoMsgLine("metaparser Blob_Method Seek %i",mmNone,Blob_Method);
        Blob_Method=Blob_Context->FindMethod("ReadData");
        DoMsgLine("metaparser Blob_Method ReadData %i",mmNone,Blob_Method);
...
CMetaDataObj* findConstant(const CString& name)		{
    return pMetaDataCont->GetConstDef(name);
}
CMetaDataObj* findReference(const CString& name)	{
    return pMetaDataCont->GetSTypeDef(name);
}
CMetaDataObj* findDocument(const CString& name)		{
    return pMetaDataCont->GetDocDef(name);
}
CMetaDataObj* findEnum(const CString& name)			{
    return pMetaDataCont->GetEnumDef(name);
}
CMetaDataObj* findJournal(const CString& name)		{
    return pMetaDataCont->GetJournalDef(name);
}
CMetaDataObj* findSelCol(const CString& name)		{
    return pMetaDataCont->GenDocSelRefs()->GetItem(name);
}
CMetaDataObj* findCalendar(const CString& name)		{
    return pMetaDataCont->GetCalendarTypeDef(name);
}
CMetaDataObj* findCalcJournal(const CString& name)	{
    return pMetaDataCont->GetCJDef(name);
}
CMetaDataObj* findAlgorithm(const CString& name)	{
    return pMetaDataCont->GetAlgorithmDef(name);
}
